...
try:
    ...
    print("Please install opencv-contrib-python to access cv2.face module")
...
def manually_fill():
    ...
    sb.geometry('700x420')
    sb.configure(background='lightblue')
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='sarthak', password='1234', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            MFW.configure(background='lightblue')
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/samar/Desktop/EDUNET/Attendance/Manually Attendance/' + DB_table_name + '.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\samar\Desktop\EDUNET\Attendance\Manually Attendance\-------Check attendance-------"')
    ...
    SUB = tk.Label(sb, text="Enter Subject : ", width=15, height=2,
                   fg="black", bg="lightblue", font=('times', 15, ' bold '))
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='sarthak', password='1234', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='lightblue')
                cs = 'C:/Users/samar/Desktop/EDUNET/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\samar\Desktop\EDUNET\Attendance\-------Check attendance-------"')
    ...
    def log_in():
        ...
        if username == 'sarthak':
            if password == '1234':
                ...
                cs = 'C:/Users/samar/Desktop/EDUNET/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    try:
        ...
        print("cv2.face module is not available. Please install opencv-contrib-python.")
        return
    global detector
    detector = cv2.CascadeClassifier(cv2.data.haarcascades + "haarcascade_frontalface_default.xml")
    try:
        ...
        Notification.configure(text=l, bg="SpringGreen3",
                               width=50,height=2, font=('times', 18, 'bold'))
...
message = tk.Label(window, text="Attendance Management System using Face Recognition", bg="black", fg="white", width=42,
